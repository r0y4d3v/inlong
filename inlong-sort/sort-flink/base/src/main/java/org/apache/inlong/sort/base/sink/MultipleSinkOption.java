...
public class MultipleSinkOption implements Serializable {
    ...
    public Map<String, String> getFormatOption() {
        return new HashMap<String, String>() {

            {
                ...
                put(SINK_MULTIPLE_DATETIME_OFFSET.key(), String.valueOf(getDatetimeOffset()));
                put(SINK_MULTIPLE_TIMESTAMP_OFFSET.key(), String.valueOf(getTimestampOffset()));
            }
        };
    }
    ...
    public static class Builder {
        ...
        public MultipleSinkOption.Builder withTimestampOffset(int timestampOffset) {
            this.timestampOffset = timestampOffset;
            return this;
        }
        public MultipleSinkOption.Builder withDatetimeOffset(int datetimeOffset) {
            this.datetimeOffset = datetimeOffset;
            return this;
        }
